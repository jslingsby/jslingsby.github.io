...
The footprint of the City of Cape Town has expanded quite drastically since the 1940s, providing a good site for this study.
...
...and draw a box and whisker plot of the reduction in burn probability by class.
...
They'll argue there's spatial autocorrelation and will want to see some fancy spatially explicit statistics that don't tell you any more than this boxplot.

So here are some convolutedly fancy stats for those of you who are interested :)
...
It turns out it takes ~12 hours to run the following code on the 10% subset of the data on a x86_64-apple-darwin13.4.0 MacBook Pro (so I've commented out the next code chunk). We'll need to run the full dataset on a cluster...
...
Which confirms what we knew already! Although it's a little difficult to interpret. Let's try a boxplot.
